...
class SalariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salary" do
    assert_difference('Salary.count') do
      post salaries_url, params: { salary: { annual_salary: @salary.annual_salary, monthly_nett_income: @salary.monthly_nett_income, salary: @salary.salary } }
    end
  ...
  test "should update salary" do
    patch salary_url(@salary), params: { salary: { annual_salary: @salary.annual_salary, monthly_nett_income: @salary.monthly_nett_income, salary: @salary.salary } }
